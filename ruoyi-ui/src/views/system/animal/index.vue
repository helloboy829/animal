<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column label="鱼类名称" prop="name" width="120" />
      <el-table-column
        label="图片"
        prop="img"
      ...
      >
        <template slot-scope="scope" v-if="scope.row.roleId !== 1">
          ...
          <el-button
            ...
            type="text"
            icon="el-icon-edit"
            @click="computedWeight(scope.row.id)"
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listAnimal(this.addDateRange(this.queryParams)).then((response) => {
    ...
    handleStatusChange(row) {
      ...
      this.$modal
        .confirm('确认要"' + text + '""' + row.roleName + '"鱼类吗？')
        .then(function () {
